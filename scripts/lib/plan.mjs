...
export const PART_LOCATIONS = {
  ...
  4: ['図書館', '拓也の家', 'カフェ', '神社・初詣', '美咲の家', 'ファミレス',
      '大学の講義棟・学食', '公園', '就活イベント',
      '家電量販店', 'プール', 'トレーニングジム', '銭湯',
      'コインランドリー', '雨宿り', '終電を逃す'],
  5: ['拓也の家', 'カフェ', '公園', '母校の高校', '大学の講義棟・学食',
      'お花見・桜', '卒業式', '引っ越し・新生活の準備', 'エレベーターに二人きり',
      '保健室', '看病', '屋上での会話'],
};
...
export const SUBDOMAIN_LOCATIONS = {
  // technology
  security:            ['データセンター見学', '銀行・ATM', 'カフェ', 'ネットカフェ', '美咲の家', '祖父母の家・田舎', '病院', '美咲のバイト先', '銭湯', '保健室', '看病'],
  network:             ['公園', '山', '海', '電車内', 'カフェ', '祖父母の家・田舎', '雨宿り', '終電を逃す', '屋上での会話'],
  ...
  system_components:   ['データセンター見学', '拓也の家', '家電量販店', 'エレベーターに二人きり'],
  hardware:            ['家電量販店', '拓也の家', 'プール', 'トレーニングジム', 'エレベーターに二人きり'],
  information_design:  ['カフェ', '図書館', '祖父母の家・田舎'],
  information_media:   ['カラオケ', '学園祭', '猫カフェ'],
  // management
  service_mgmt:        ['データセンター見学', '美咲のバイト先', 'コンビニ', 'ファミレス', 'コインランドリー', '看病'],
  project_mgmt:        ['学園祭', '東大の研究室', '大学の講義棟・学食'],
  system_audit:        ['就活イベント', '銀行・ATM', '病院', '卒業式'],
  software_dev_mgmt:   ['東大の研究室', '拓也の家'],
  development_tech:    ['東大の研究室', '学園祭', '拓也の家', '引っ越し・新生活の準備'],
  // strategy
  legal:               ['就活イベント', '図書館', 'カラオケ', '病院', '母校の高校', '卒業式', '保健室'],
  business_industry:   ['スーパー・商店街', 'コンビニ', '祖父母の家・田舎', '遊園地', 'お花見・桜'],
  corporate_activity:  ['就活イベント', 'ファミレス', '学園祭', '美咲のバイト先'],
  system_strategy:     ['就活イベント', 'ファミレス', 'カフェ'],
  management_strategy: ['ファミレス', 'スーパー・商店街', 'カフェ', 'トレーニングジム'],
  technology_strategy: ['東大の研究室', 'データセンター見学'],
  system_planning:     ['学園祭', '東大の研究室', '就活イベント', '引っ越し・新生活の準備'],
};
